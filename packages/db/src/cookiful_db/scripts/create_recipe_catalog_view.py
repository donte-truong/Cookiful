...
from cookiful_db.views import CREATE_RECIPE_CATALOG_VIEW_SQL, DROP_RECIPE_CATALOG_VIEW_SQL, RECIPE_CATALOG_VIEW_NAME


def create_recipe_catalog_view() -> None:
    with engine.begin() as connection:
        connection.exec_driver_sql(DROP_RECIPE_CATALOG_VIEW_SQL)
